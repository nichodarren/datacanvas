...
| **Versi** | 0.14.1 |
| **Status** | 🟢 **Baseline aktif** — seluruh keputusan D-001…D-036 Accepted; Gerbang 0, 1 & 2 terlampaui; dokumen ini mengikat untuk implementasi |
| **Tanggal** | 2026-08-01 |
...
| **Q-2** | `prefers-reduced-motion` dihormati | ⚠️ Belum relevan — nol animasi hari ini. **Mengikat begitu ada yang pertama** |
| **Q-3** | Kontras memenuhi WCAG AA | ✅ Ditegakkan `tests/test_design_tokens.py` (NFR-UX.3) |
| **Q-4** | **Emoji bukan ikon.** Emoji berubah bentuk antar platform dan dibacakan screen reader sebagai nama Unicode-nya | ⚠️ **Dilanggar hari ini** — `📌` pada tombol pin. Dipanen dari UUPM (prioritas 4), yang tidak dipasang |
| **Q-5** | Target sentuh ≥ 44×44px | ⚠️ **Belum diperiksa.** Tombol kita ± 30px. Relevan untuk NFR-UX.4 (*"tidak rusak di tablet"*) |
